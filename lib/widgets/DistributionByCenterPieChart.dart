...
class DistributionByCenterPieChart extends StatelessWidget {
  final List<Map<String, dynamic>> data;

  const DistributionByCenterPieChart({Key? key, required this.data}) : super(key: key);
  ...
  // Asignar colores a las etiquetas de los centros
